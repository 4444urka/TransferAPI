...
class VehicleAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'vehicle_type', 'license_plate', 'total_seats', 'rows', 'seats_per_row', 'is_comfort', 'air_conditioning', 'allows_pets')
    list_filter = ('vehicle_type', 'is_comfort', 'air_conditioning', 'allows_pets')
    search_fields = ('license_plate',)
    fieldsets = (
        (None, {'fields': ('vehicle_type', 'license_plate', 'total_seats', 'rows', 'seats_per_row')}),
