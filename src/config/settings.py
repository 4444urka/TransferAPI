...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME", default="transfer_db"),
        "USER": env("DB_USER", default="busser_killer"),
        "PASSWORD": env("DB_PASSWORD", default="MbU?rU9&^FfBWrv&s=tw"),
...
CELERY_BROKER_URL = env(
    "RABBITMQ_URL", default="amqp://busser_killer:password@rabbitmq:5672/"
)
